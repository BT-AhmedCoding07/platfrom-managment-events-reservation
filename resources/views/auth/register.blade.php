...
@section('content')
<h1 class="text-3xl text-green-500 mb-6 text-center mt-5">S'inscire</h1>
<form method="POST" action="{{ route('register') }}" class="w-full max-w-sm mx-auto rounded-lg border shadow-md p-5 mb-5">
    ...
    <div class="flex justify-between items-center">
        <label for="association">Une Association
            <input type="radio" value="1" id="association" name="role_id">
            <span class="checkmark"></span>
        </label>
        <label for="client">Un Client
